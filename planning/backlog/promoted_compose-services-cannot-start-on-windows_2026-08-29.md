...
status: promoted
date: 2026-08-29
promoted_to: node-services-get-a-dockerfile_2026-09-01
---

# Three Compose Services Cannot Start on Windows

**Status:** Promoted 2026-09-01 to `node-services-get-a-dockerfile_2026-09-01`

**Restored 2026-09-05.** This stub was deleted on promotion in commit `53be032`, against
`plan-workflow`'s own "never delete plan documents" — which left the plan it became pointing at a
file that did not exist. `validate:plans` caught the dangling reference; the stub is back from
history, because the corpus is the record and a promotion is not a deletion.
