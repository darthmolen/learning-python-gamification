...
- **Phase 2 exit condition / the son's laptop failure path**
  - Phase 2's laptop check is the exit condition, but the plan does not say what happens if the check fails — does Phase 2 block, does design defer, or is it a known-acceptable shortfall?
