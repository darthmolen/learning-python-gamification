...
This is the **third pass** at reading errors (§3 principle 7). Area 0 Practice 3 was
`reading-errors` in tiny one-frame files. Area 1 Practice 6 was the same skill against
