...
**Practices 5–8 turn that round.** The toolchain half is Python files in real directories,
...
**`*.py` — in 2a, the things you do it to.** Deliberately easy. Practice 2 is about `add`
...
traceback with three frames in it. Practices 5–8's files do exactly those things.
...
Four of Practice 8's files are **supposed to fail**, and their tags say which error. An
...
Git Bash, and Practice 7 is entirely about why that matters. Until then, one command
everywhere.

**Practice 7 is where that rule gets its exception**, and it is the only one: inside an
