...
If you can, your practice-2 messages were good. If you cannot, they were not, and this is
...
## 7. Check your practice-1 guesses

In Practice 1 you wrote down guesses about `HEAD` and `objects`. Go and look:
...
- [ ] You checked your `HEAD` and `objects` guesses from Practice 1
