...
> happens to all of it if this machine gets dropped tomorrow?"
...
### `practices/practice-4/w4_push_and_prove_it.md`
...
Say so, briefly. Practices 5 to 8 are a different kind of evening: Python files in real
