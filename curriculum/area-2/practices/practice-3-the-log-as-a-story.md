...
**Files:** `practices/practice-3/`
**Journal:** entry as normal, committed

Practice 2 planted a trap. This session springs it, and then uses the resulting motivation
...
Then read him back his practice-2 forecast about what would break. It is probably about to
...
### `practices/practice-3/w3_the_log_as_a_story.md`
...
### Step 7 — mark his practice-1 guesses
