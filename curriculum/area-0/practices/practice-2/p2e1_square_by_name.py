...
Last couple of practices you drew shapes by typing numbers directly into the orders.
...
A variable is a name for a value. Write the number once, use the variable everywhere.

Run:  py -3.14 p2e1_square_by_name.py
"""
...
#
# 2. Now make it a rectangle. You will need a second variable. Choose the variable name yourself;
#    "side" is no longer a good variable name for either number, so rename that too.
#
