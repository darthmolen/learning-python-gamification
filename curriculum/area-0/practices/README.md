...
terminal. Read it — that is Practice 3, and it is a good day for it to arrive early.
...
Three files ask you to write predictions on paper **before** running: `p1e2`, `p4e1`,
and every file in `practice-3`.
