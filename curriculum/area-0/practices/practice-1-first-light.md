...
on purpose, and read the error. That is the seed for Practice 3. If time is short, cut
...
That exchange, in Practice 1, minute 12, is the single most load-bearing thing in Area 0.

---

## If you have 45 minutes and not 60

Cut `p1e3` and set it as something to play with alone. Do not cut the REPL hook and
