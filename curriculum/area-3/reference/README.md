...
Spec §5.5 makes a reference solution a **Datamine payload**: the learner may take one, and
taking one costs 5 XP. The cost is the point. Every question these files answer is one the
learner could have answered by printing something, and the medal system says so out loud
rather than pretending the help was free.
...
**These run under `verify.py` like everything else**, and they carry the same header tags.
A reference solution that had quietly stopped working would be the worst file in the area to
hand somebody.
