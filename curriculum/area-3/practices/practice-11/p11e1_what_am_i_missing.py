"""What Am I Missing — the loop you wrote in practice 5, in one character.
...
You already wrote this. Practice 5 walked a list of needed things, checked each
...
Run:  py -3.14 p11e1_what_am_i_missing.py
"""
...
print()
print("the long way, from practice 5:")
missing_long = []
for thing in need:
