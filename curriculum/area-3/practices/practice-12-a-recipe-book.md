...
will do next week under their own steam. Area 0 scheduled its practice 6 the same way and the
...
Callback to practice 8, task 3 — they were asked what shape would hold two recipes at once,
...
### `p12e1_a_recipe_book.py` — the shape, and what you can build
...
### `p12e2_print_the_middle.py` — the habit, done deliberately
...
is practice 11's judgment applied to their own data, and anyone who answers it well is ready
for the boss.
