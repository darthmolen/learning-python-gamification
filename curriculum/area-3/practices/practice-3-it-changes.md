...
### `p3e1_two_names_one_list.py` — the two names, watched
...
### `p3e2_sort_hands_back_nothing.py` — the `None` that costs everybody an evening
...
**`sorted()` appears here as the contrast and is properly taught in practice 5.** Introduce
