...
### `p2e1_the_inventory.py` — positions, both directions
...
### `p2e2_off_by_one.py` — the crash, on purpose
...
example.** They will need it again in practice 6 and having written it once is what makes the
