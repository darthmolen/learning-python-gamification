...
That last one is worth remembering after session 3: `spare = inventory[:]` is a
copy, where `spare = inventory` is a second name.

**A slice hands you a new list.** The original is never touched.

Run:  py -3.14 s6e1_the_hotbar.py
"""
...
#
# 3. Ask for `inventory[0:99]`. In session 2, asking for a slot past the end
