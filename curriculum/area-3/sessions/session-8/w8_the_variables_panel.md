...
This is the tool half of session 8. There is no file to run and nothing for a harness to
...
You will need `s8e2_the_key_that_is_not_there.py` open. It crashes on purpose, and it is the
...
Open `s8e2_the_key_that_is_not_there.py`. Find this line:
