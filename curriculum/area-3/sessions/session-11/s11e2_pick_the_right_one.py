...
Run:  py -3.14 s11e2_pick_the_right_one.py
"""
...
print("built with .get(thing, 0) + 1 -- session 9's default, doing real work.")
...
#    just the number, and session 9's move 4 asked the same thing.
