...
p3e2, and the clumsy line-counting in p2e2's choice board. Tonight it gets a name and a
job, which is the right order: Practice 8 gives the pattern something to do rather than
defining it at them.
...
Task 4 is the silent one and it is why this session sits after Practice 6: change
