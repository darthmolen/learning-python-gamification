...
Five files ask for written predictions **before** running: `p1e2`, `p2e1`, `p4e1`,
`p5e1`, and every file in `practice-6`.
...
## Practice 6 is different, and differently from Area 0

Those six files are **broken on purpose** and most of them do not crash.

Area 0's Practice 3 was seven files that all announced their failure. Here, three of the
