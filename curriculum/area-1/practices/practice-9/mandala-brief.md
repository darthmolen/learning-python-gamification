...
everything you need and you have had it since Practice 8.
...
- **The tile.** A grid — p7e2 — where the thing in each cell rotates a bit more as
  you go across.
...
`turtle.speed(0)` you have had since Practice 1.
...
If it hangs, that is a practice-3 problem and you know the key. If it draws the wrong
thing silently, that is a practice-6 problem and you know the tool: make it count, and
print the count.
