...
better once they have watched a shape grow.
...
They will say seven. Everybody says seven. Everybody adds.
...
Point at the indentation with a finger. Do not read it out for them. Say plainly that
...
**Three loops deep now.** Task 1 asks them to say which loop each line is in and prove it
by predicting how many times each runs.
...
top" bought them back in Practice 1.
...
Entry 13. Worth capturing honestly: **whether they predicted 12 or 7.** They will want to
...
**Let them get wrong:** the multiplication. Ask for the prediction before every run
tonight.

## Success condition

They can write a loop inside a loop, say how many times the inner body runs without running
