...
legal. **They cannot fix either tonight and both go in the Journal.** Practice 5 fixes
...
all. Practice 7 lands much harder if they have felt this first.

## Compression note

If the calendar bites, this session merges into Practice 1. Keep `p2e1`'s five predictions
and `p2e3`'s dial; `p2e2` can go to their own time.
