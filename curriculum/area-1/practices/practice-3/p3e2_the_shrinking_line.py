...
#
# 3. Change 0.8 to 1.0 and DO NOT RUN IT. Look at the three rules from p3e1.
...
#    It has a name -- the accumulator -- and Practice 8 is entirely about it.
...
#         (you will need a second counter. Try. It is Practice 8's job and
#          having tried it once makes Practice 8 twenty minutes shorter.)
# -----------------------------------------------------------------------------
