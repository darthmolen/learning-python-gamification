...
p1e3 had one number at the top and you turned it by editing the file. That is
...
#    and in Practice 5 you can fix both.
#
...
#         the last (this is Practice 7 arriving early -- have a go)
