...
> see inside a running program until Tier 7, and honestly it's the way I still do it
> most days."
...
That exchange, in session 1, minute 12, is the single most load-bearing thing in Tier 0.
...
`turtle.bgcolor("black")`. All positional, all Tier 0 legal. Let him find out what
