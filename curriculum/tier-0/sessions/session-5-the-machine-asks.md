...
time in the tier that a program has waited for anything, and it is worth one sentence.
...
3. Ask for a colour as well. Ask him first whether a colour needs converting, and why
   not.
4. Ask for the number of sides and print the total turn. He cannot draw it yet — Tier 1
