...
Then move on — the mechanism is not Tier 0 material, but the fact that it exists is, and
...
**It is fine for this session to be the weak one.** Sessions 3, 5 and 6 carry the tier.
