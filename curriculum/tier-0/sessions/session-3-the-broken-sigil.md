...
This is the session the tier is built around. Spec §3 principle 5 is *never hide
...
That is the whole of Tier 0's `reading-errors` concept, and everything after this
