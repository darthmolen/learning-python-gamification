...
- **The game owns pace; the lesson owns teaching** (ADR 0006). Lesson prose places the reader
  in the **sequence** and never on the **calendar**: "Area 4 gave you functions" is fine,
  "Six weeks." is not, and neither is "in about three weeks". The test is whether the sentence
  survives a learner who took twice as long. Week counts belong in `area.yml`, session plans
  and the DM guide, which are written for somebody running a calendar.
